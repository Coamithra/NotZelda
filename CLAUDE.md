...
- **`server/validation.py`** — `validate_monster()`, `validate_tile()`, `register_monster_type()`, `register_tile_type()`. Validation constants for tile ops, behavior conditions/actions, attack types.
