...
const PLAYER_WALK_FRAMES = {
  ...
  left: [
    // F0 — Stride A: wide stance, head leaned forward, arm behind (hand peeks far side)
    [
    ...
    // F3 — Stride B: wide stance, head leaned forward, arm swung forward
    [
      ["HAIR", 3, 0, 6, 2], ["HAIR", 7, 2, 2, 4],
      ["SKIN", 3, 2, 4, 4], ["#222", 3, 3, 1, 1],
  ...
  right: [
    // F0 — Stride A: head leaned forward, arm behind (hand peeks far side) (mirrored)
    [
    ...
    // F3 — Stride B: head leaned forward, arm swung forward (mirrored)
    [
      ["HAIR", 7, 0, 6, 2], ["HAIR", 7, 2, 2, 4],
      ["SKIN", 9, 2, 4, 4], ["#222",12, 3, 1, 1],
