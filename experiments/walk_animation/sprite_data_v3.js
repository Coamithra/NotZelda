...
const PLAYER_WALK_FRAMES = {
  ...
  left: [
    // F0 — Stride A: neutral head, arm behind (hand peeks far side), mouth
    [
    ...
    // F1 — Closing A: legs narrowing, arm emerging
    [
      ["HAIR", 4, 0, 6, 2], ["HAIR", 8, 2, 2, 4],
      ["SKIN", 4, 2, 4, 4], ["#222", 4, 3, 1, 1],
    ...
    // F2 — Pass: legs together, body bobbed up 1px, hair trails wider
    [
      ["HAIR", 4,-1, 6, 2], ["HAIR", 8, 1, 3, 4],
      ["SKIN", 4, 1, 4, 4], ["#222", 4, 2, 1, 1],
      ["SHIRT", 5, 5, 6, 5], ["SHIRT", 4, 6, 1, 3], ["SKIN", 4, 9, 1, 1],
      ["PANTS", 5,10, 5, 2],
      ["BOOTS", 5,12, 3, 2],
    ],
    // F3 — Stride B: head leaned forward, arm swung forward, mouth
    [
    ...
    // F4 — Closing B: legs narrowing, arm retracting
    [
      ["HAIR", 4, 0, 6, 2], ["HAIR", 8, 2, 2, 4],
      ["SKIN", 4, 2, 4, 4], ["#222", 4, 3, 1, 1],
  ...
  right: [
    // F0 — Stride A: neutral head, arm behind (hand peeks far side), mouth (mirrored)
    [
    ...
    // F1 — Closing A: legs narrowing, arm emerging (mirrored)
    [
      ["HAIR", 6, 0, 6, 2], ["HAIR", 6, 2, 2, 4],
      ["SKIN", 8, 2, 4, 4], ["#222",11, 3, 1, 1],
      ["SHIRT", 5, 6, 6, 5], ["SHIRT",11, 7, 1, 2],
      ["PANTS", 6,11, 3, 2], ["PANTS", 7,11, 3, 2],
      ["BOOTS", 7,13, 2, 2], ["BOOTS",10,13, 2, 2],
    ],
    // F2 — Pass: legs together, body bobbed up 1px, hair trails wider (mirrored)
    [
      ["HAIR", 6,-1, 6, 2], ["HAIR", 5, 1, 3, 4],
      ["SKIN", 8, 1, 4, 4], ["#222",11, 2, 1, 1],
      ["SHIRT", 5, 5, 6, 5], ["SHIRT",11, 6, 1, 3], ["SKIN",11, 9, 1, 1],
      ["PANTS", 6,10, 5, 2],
      ["BOOTS", 8,12, 3, 2],
    ],
    // F3 — Stride B: head leaned forward, arm swung forward, mouth (mirrored)
    [
    ...
    // F4 — Closing B: legs narrowing, arm retracting (mirrored)
    [
      ["HAIR", 6, 0, 6, 2], ["HAIR", 6, 2, 2, 4],
      ["SKIN", 8, 2, 4, 4], ["#222",11, 3, 1, 1],
