...
const PLAYER_WALK_FRAMES = {
  ...
  left: [
    // F0 — Stride A: wide legs, arm reaching forward with prominent fist, head lean
    [
      ["HAIR", 3, 0, 6, 2], ["HAIR", 7, 2, 2, 4],
      ["SKIN", 3, 2, 4, 4], ["#222", 3, 3, 1, 1],
      ["SHIRT", 5, 6, 6, 5],
      ["SHIRT", 3, 7, 2, 1],                           // upper arm (2px wide)
      ["SKIN", 1, 8, 2, 2],                            // fist (2x2, prominent)
      ["PANTS", 3,11, 3, 2], ["PANTS", 9,11, 2, 2],
      ["BOOTS", 2,13, 3, 2], ["BOOTS", 9,13, 2, 2],
    ],
    // F1 — Closing A: legs narrowing, arm retracting
    [
      ["HAIR", 4, 0, 6, 2], ["HAIR", 8, 2, 2, 4],
      ["SKIN", 4, 2, 4, 4], ["#222", 4, 3, 1, 1],
      ["SHIRT", 5, 6, 6, 5],
      ["SHIRT", 4, 7, 1, 2], ["SKIN", 3, 9, 1, 1],
      ["PANTS", 4,11, 3, 2], ["PANTS", 7,11, 3, 2],
      ["BOOTS", 4,13, 2, 2], ["BOOTS", 7,13, 2, 2],
    ],
    // F2 — Pass: legs together, body bobbed up 1px
    [
    ...
    // F3 — Stride B: wide legs (opposite), arm behind, back hand peeks
    [
      ["HAIR", 3, 0, 6, 2], ["HAIR", 7, 2, 2, 4],
      ["SKIN", 3, 2, 4, 4], ["#222", 3, 3, 1, 1],
      ["SHIRT", 5, 6, 6, 5],
      ["SHIRT", 4, 7, 1, 1],                           // shoulder stub
      ["SKIN",11, 8, 1, 2],                            // back hand peeks (1x2)
      ["PANTS", 4,11, 2, 2], ["PANTS", 8,11, 3, 2],
      ["BOOTS", 3,13, 2, 2], ["BOOTS", 8,13, 3, 2],
    ],
    // F4 — Closing B: legs narrowing, arm emerging forward
    [
      ["HAIR", 4, 0, 6, 2], ["HAIR", 8, 2, 2, 4],
      ["SKIN", 4, 2, 4, 4], ["#222", 4, 3, 1, 1],
      ["SHIRT", 5, 6, 6, 5],
      ["SHIRT", 3, 7, 1, 2], ["SKIN", 3, 9, 1, 1],
  ...
  right: [
    // F0 — Stride A: mirrored
    [
      ["HAIR", 7, 0, 6, 2], ["HAIR", 7, 2, 2, 4],
      ["SKIN", 9, 2, 4, 4], ["#222",12, 3, 1, 1],
      ["SHIRT", 5, 6, 6, 5],
      ["SHIRT",11, 7, 2, 1],
      ["SKIN",13, 8, 2, 2],
      ["PANTS", 5,11, 2, 2], ["PANTS",10,11, 3, 2],
      ["BOOTS", 5,13, 2, 2], ["BOOTS",11,13, 3, 2],
    ],
    // F1 — Closing A: mirrored
    [
      ["HAIR", 6, 0, 6, 2], ["HAIR", 6, 2, 2, 4],
      ["SKIN", 8, 2, 4, 4], ["#222",11, 3, 1, 1],
      ["SHIRT", 5, 6, 6, 5],
      ["SHIRT",11, 7, 1, 2], ["SKIN",12, 9, 1, 1],
      ["PANTS", 6,11, 3, 2], ["PANTS", 9,11, 3, 2],
    ...
    [
      ...
      ["SHIRT",11, 7, 1, 1],
      ["SKIN", 4, 8, 1, 2],
      ["PANTS", 5,11, 3, 2], ["PANTS",10,11, 2, 2],
      ["BOOTS", 5,13, 3, 2], ["BOOTS",11,13, 2, 2],
    ],
    // F4 — Closing B: mirrored
    [
      ["HAIR", 6, 0, 6, 2], ["HAIR", 6, 2, 2, 4],
      ["SKIN", 8, 2, 4, 4], ["#222",11, 3, 1, 1],
      ["SHIRT", 5, 6, 6, 5],
      ["SHIRT",12, 7, 1, 2], ["SKIN",12, 9, 1, 1],
